...
def search():
    try:
        ...
        im5 = im5.resize((150, 150), Image.Resampling.LANCZOS)
        ...
        im7 = im7.resize((40, 40), Image.Resampling.LANCZOS)
...
im1 = im1.resize((40, 40), Image.Resampling.LANCZOS)
...
im2 = im2.resize((40, 40), Image.Resampling.LANCZOS)
